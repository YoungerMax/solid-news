...
const App: Component = () => {
	...
	return (
		<>
			<main class="container sm:mx-auto sm:w-2/3 p-4 grid dark:bg-dark-800">
				<div class="mb-4 sm:my-10 flex items-center">
					<Link href="/" class="flex gap-2 sm:gap-6 items-center" style={{ 'text-decoration': 'none' }}>
						<img src="/images/logo.svg" class="w-8 sm:w-16 rounded" alt="Solid News logo" width="64" height="64" />
